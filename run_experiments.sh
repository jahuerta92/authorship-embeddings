...
python3 run_experiment.py --devices 1 --model lstm --books --mails --blogs --batch_size 2048 --vbatch_size 100 --scheduler enable
python3 run_experiment.py --devices 1 --model max --books --mails --blogs --batch_size 2048 --vbatch_size 100 --scheduler enable
python3 run_experiment.py --devices 1 --model mean --books --mails --blogs --batch_size 2048 --vbatch_size 100 --scheduler enable
